...
try{
  await pool.query(await readFile(new URL('../mentoring_prospective_student_mentors.sql',import.meta.url),'utf8'));
  console.log('Prospective student mentor schema applied successfully.');
