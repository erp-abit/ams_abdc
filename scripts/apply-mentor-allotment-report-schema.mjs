...
try{
  await pool.query(await readFile(new URL('../mentoring_mentor_allotment_report.sql',import.meta.url),'utf8'));
  console.log('Mentor allotment report schema applied successfully.');
